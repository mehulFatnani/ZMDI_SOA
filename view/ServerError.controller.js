sap.ui.define([
	...
	"mdi/crm/mdi/util/Statics"
], function(jQuery, Controller, UIComponent, MDIStatics) {
	"use strict";

	return Controller.extend("mdi.crm.soa.view.ServerError", {
		_oRoutingParams: {},
		...
		onRouteMatched: function(oEvent) {
			...
			*/
			switch (oParameters.name) {
				case MDIConstants.ROUTE_NAME_SERVER_ERROR:
